          ...
          <div className="lg:col-span-3 space-y-4">
            {selectedFolderBoards.length === 0 ? (
              <EmptyState
                icons={[Clipboard]}
                title={
                  selectedFolder ? "No boards in this folder" : "No boards yet"
                }
                description={
                  selectedFolder
                ...
                {selectedFolderBoards.map(board => (
                  <BoardCard
                    ...
                    board={{
                      ...
                      postCount: (board as any).post_count || 0,
                      updatedAt: new Date(
                        (board as any).updated_at || (board as any).created_at
                      ),
                      isPublic: (board as any).is_shared || false,
                      createdAt: new Date((board as any).created_at),
