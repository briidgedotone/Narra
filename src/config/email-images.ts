...
export const EMAIL_IMAGES = {
  ...
  SUCCESS_ICON: 'https://cvkqgduefcvkeagfvvgr.supabase.co/storage/v1/object/public/email-assets/success-icon.png',
  FAILED_ICON: 'https://cvkqgduefcvkeagfvvgr.supabase.co/storage/v1/object/public/email-assets/failed-icon.png'
