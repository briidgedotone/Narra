...
async function main() {
  ...
  // Read URLs from file
  const urlsFilePath = join(process.cwd(), 'collections', 'best-of-ecommerce-collection.txt');
  ...
  // TODO: Replace with actual Best of eCommerce board ID
  // We found earlier this should be: 877a7dde-74ce-42c8-901b-20db491662b1
