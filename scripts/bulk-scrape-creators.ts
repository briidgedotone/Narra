...
// Copy the BulkScrapeProcessor class (same as viral hooks script)
...
// Main
async function main() {
  console.log('🎯 Best of Creators Bulk Scraper');
  console.log('================================\n');

  const urlsFilePath = join(process.cwd(), 'collections', 'best-of-creators-collection.txt');
  ...
  const boardId = 'f5e6d7c8-9a0b-1c2d-3e4f-5a6b7c8d9e0f';
  console.log('📌 Using Best of Creators board');
  ...
  console.log('\n🎉 Best of Creators bulk scrape completed!');
}
